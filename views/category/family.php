                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $i=1;
                                    //print_r($data);
                                    foreach ($data["familyincome"] as $indiincvalue) 
                                    {
                                    ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        ...
                                        <td><?php                                             
                                                ...
                                                if($indiincvalue["applied_for"]==3){ $group="Group"; }
                                                echo $group;
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $i=1;
                                    //print_r($data);
                                    foreach ($data["familyexpense"] as $indiexpvalue) 
                                    {
                                    ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        ...
                                        <td><?php                                             
                                                ...
                                                if($indiexpvalue["applied_for"]==3){ $group="Company"; }
                                                echo $group;
