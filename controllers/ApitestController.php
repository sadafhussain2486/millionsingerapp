                            ...
                            { 
                                ...
                                foreach ($csumdata as $value) 
                                {
                                    ...
                                    $cat[$rc]=array(
                                        ...
                                        'budget'=>(!empty($budgetamount["amount"]))?$budgetamount["amount"]:0,                                        
                                    );
                                    $rc++;
                                    $totaltarget1+=$sum;
                                ...
                                { 
                                    ...
                                    {                                    
                                        ...
                                        $cat[$rc]=array(
                                            ...
                                            'category_name' => ($catexpdata['category_name']!=null)?$catexpdata['category_name']:'',
                ...
                if(!empty($getid))
                {
                    ...
                    if(!empty($analcategory))
                    {
                        foreach ($analcategory as $analcatval)
                        {
                            ...
                            $categorydata[]=array(
                                    'category'=>$model5->categoryname($analcatval["category_id"]),
                    ...
                    if($data["type"]==2)
                    {
                        ...
                        {           
                            ...
                            $netspent[]=array('user_id'=>$model3->displayname($uservalue["id"]),'username'=>$model3->displayname($uservalue["id"],'username'),'amount'=>(!empty($netamount))?$netamount:0,'percentage'=>$totalpernet.'%');
                        }                        
        ...
        if(Yii::$app->getRequest()->method==="POST")
        {
            ...
            if(!empty($data['token']) && isset($data['token']))
            {
                ...
                if(!empty($getid))
                {
                    ...
                    /*//News
                    $catdata2=$model->find()->where(['status' => 1,'category'=>2])
                                            ->andWhere(['<=','ads_startdate', $currentdate])
                                            ->andWhere(['>=','ads_enddate', $currentdate])
                                            ->orderBy(['id'=>SORT_DESC])
                                            ->all();
                    ...
                    //profile
                    $catdata3=$model->find()->where(['status' => 1,'category'=>3])
                                            ->andWhere(['<=','ads_startdate', $currentdate])
                                            ->andWhere(['>=','ads_enddate', $currentdate])
                                            ->orderBy(['id'=>SORT_DESC])
                                            ->all();
